					...
					<div class="col-md-10">
						<div class="panel panel-default">
						    ...
						    <div class="panel-body">
								<form class="form-horizontal" role="form" action="/EditClasses.do" id="editfrom" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="courseTime" value="${classes.courseTime}" placeholder="请输入上课时间">
										</div>
									</div>
									<div class="form-group">
										<label for="inputPassword3" class="col-sm-2 control-label">上课地点</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" name="classRoom" value="${classes.classRoom}" placeholder="上课地点">
										</div>
									</div>
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-2 control-label">周数</label>
										<div class="col-sm-10">
											<input type="number" class="form-control" name="courseWeek" value="${classes.courseWeek}" placeholder="请输入周数">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="number" class="form-control" name="score" value="${classes.score}" placeholder="请输入学分">
										</div>
									</div>
