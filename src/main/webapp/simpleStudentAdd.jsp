				...
				<div class="col-md-10">
					<div class="panel panel-default">
					    ...
					    <div class="panel-body">
							<form class="form-horizontal" role="form" action="/AddStudent.do" id="editfrom" method="post">
...
<%--								  </div>--%>
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
									    <input type="date" value="2000-01-01" name="birthYear"/>
								    </div>
								  </div>
								  <div class="form-group">
								    <label for="inputPassword3" class="col-sm-2 control-label" name="grade">入学时间</label>
								    <div class="col-sm-10">
									    <input type="date" value="2000-01-01" name="grade"/>
								    </div>
								  </div>
								  <div class="form-group">
